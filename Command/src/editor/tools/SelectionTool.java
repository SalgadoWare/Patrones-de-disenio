...
public class SelectionTool implements Tool
{
	...
	public void release() 
	{
		...
		if (selectedFigure == null) {
			editor.trace("Al no haber ninguna figura seleccionada que se estuviera moviendo, no hay nada que hacer");
			return;
		}
		editor.getActionManager().addUndoableAction(new MoveAction(selectedFigure, dX, dY));
		reset(); // hay que dejar la herramienta en su estado inicial tras soltar
	}

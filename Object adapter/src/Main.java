import adapter.MonumentoAdapter;
...
public class Main 
{
	public static void main(String[] args) 
	{
		...
		// TODO: Añadir al mapa los tres elementos anteriores
		// ...
		
		
		map.add(new MonumentoAdapter(coliseo));
		map.add(new PhotoAdapter(myPhoto));
		map.add(new RestaurantAdapter(elGladiador));
